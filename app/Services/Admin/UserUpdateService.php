...
class UserUpdateService
{
    ...
    public function update(array $data, User $user): User
    {
        ...
        try {
            ...
            $this->fillUser($user, $data, $imagePath);
     ...
     * @param string $imagePath Путь к аватару пользователя.
     * @return void
     */
    private function fillUser(User $user, array $data, string $imagePath): void
    {
        $user->fill([
            'name' => $data['name'],
            'email' => $data['email'],
